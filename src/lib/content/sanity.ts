...
import {createProjectMapper, type RawProject, type RawImage} from './project'
...
const {responsiveImage, mapProject} = createProjectMapper(sanityProjectId, sanityDataset)
