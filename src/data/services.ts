...
export const services: Service[] = [
  {
    ...
    headline: 'Damit Menschen schnell verstehen, warum genau dieses Angebot für sie relevant ist.',
    ...
    chapters: [
      {
        title: 'Wenn alles wichtig klingt, bleibt nichts hängen.',
      ...
      {
        title: 'Eine klare Idee trägt weiter als ein einzelnes Medium.',
    ...
    casesIntro: 'Wie aus einer klaren Haltung konkrete Kommunikation wird.',
    cases: [
  ...
  },
  {
    ...
    headline: 'Ein Erscheinungsbild, das nicht nur gut aussieht, sondern Entscheidungen leichter macht.',
    ...
    chapters: [
      {
        title: 'Charakter entsteht durch Entscheidungen.',
      ...
      {
        title: 'Ein gutes System wächst mit, ohne beliebig zu werden.',
    ...
    casesIntro: 'Zwei Marken, zwei sehr unterschiedliche Arten von Klarheit.',
    cases: [
  ...
  },
  {
    ...
    headline: 'Eine starke Idee, die Menschen erreicht und über alle Berührungspunkte zusammenhält.',
    ...
    chapters: [
      {
        title: 'Der Anlass gibt den Takt vor, nicht das Format.',
      ...
      {
        title: 'Reichweite entsteht durch Konsequenz und Variation.',
    ...
    casesIntro: 'Wenn eine Leitidee viele Situationen tragen kann.',
    cases: [
  ...
  },
  {
    ...
    headline: 'Digitale Auftritte, die Orientierung geben und die Qualität eines Angebots spürbar machen.',
    ...
    chapters: [
      {
        title: 'Zuerst entsteht der Weg durch die Inhalte.',
      ...
      {
        title: 'Die Marke muss sich digital richtig anfühlen.',
    ...
    casesIntro: 'Digitale Systeme, die den Charakter der Marke weitertragen.',
    cases: [
